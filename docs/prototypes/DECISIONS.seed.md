...
## KVE (kve)
- **CQ-3-rot uses a FIXED Walsh-Hadamard rotation, not randomized** · seed sweep showed randomized
  is a per-seed lottery; fixed is reliably −0.009 and the incoherence insurance never paid · 2026-07-20.
